...
describe('UrlUtils', () => {
	describe('isMicrosoftDocumentationUrl', () => {
		it('should return true for msdn.microsoft.com, docs.microsoft.com, and learn.microsoft.com', () => {
			expect(isMicrosoftDocumentationUrl(new URL('https://learn.microsoft.com/abcd'))).toBe(true);
			expect(isMicrosoftDocumentationUrl(new URL('https://docs.microsoft.com/abcd'))).toBe(true);
			expect(isMicrosoftDocumentationUrl(new URL('https://msdn.microsoft.com/abcd'))).toBe(true);
		});

		it('should return false for other sites', () => {
			expect(isMicrosoftDocumentationUrl(new URL('https://example.microsoft.com/'))).toBe(false);
		});
	});
